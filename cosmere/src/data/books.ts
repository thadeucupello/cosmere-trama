...
export const books: Book[] = [
  ...
  },
  {
    ...
    world: 'scadrial',
    order: 4,
    description: 'Os três romances que iniciam a saga reunidos em um único box: O Império Final, O Poço da Ascensão e O Herói das Eras. A jornada completa para entrar na Cosmere desde a primeira página.',
    status: 'published',
  ...
  // MISTBORN — HISTÓRIA SECRETA (novela bônus, contém spoilers da trilogia original)
  {
    ...
    world: 'scadrial',
    order: 5,
    description: 'Uma história escondida entre as páginas da Trilogia Original. Descubra o que acontecia além do que os personagens podiam ver e dê o primeiro passo em direção aos segredos maiores da Cosmere.',
    status: 'published',
